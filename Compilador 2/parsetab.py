...
_lr_productions = [
  ...
  ('read_statement -> READ IDENTIFIER SEMICOLON','read_statement',3,'p_read_statement','compilador.py',149),
  ('declaration -> INT var_list SEMICOLON','declaration',3,'p_declaration','compilador.py',161),
  ('declaration -> FLOAT var_list SEMICOLON','declaration',3,'p_declaration','compilador.py',162),
  ('declaration -> BOOL var_list SEMICOLON','declaration',3,'p_declaration','compilador.py',163),
  ('var_list -> var_list COMMA IDENTIFIER','var_list',3,'p_var_list','compilador.py',182),
  ('var_list -> IDENTIFIER','var_list',1,'p_var_list','compilador.py',183),
  ('statements -> statements statement','statements',2,'p_statements','compilador.py',193),
  ('statements -> empty','statements',1,'p_statements','compilador.py',194),
  ('statement -> assignment','statement',1,'p_statement','compilador.py',201),
  ('statement -> if_statement','statement',1,'p_statement','compilador.py',202),
  ('statement -> write_statement','statement',1,'p_statement','compilador.py',203),
  ('statement -> read_statement','statement',1,'p_statement','compilador.py',204),
  ('statement -> do_statement','statement',1,'p_statement','compilador.py',205),
  ('statement -> while_statement','statement',1,'p_statement','compilador.py',206),
  ('assignment -> IDENTIFIER ASSIGN expression SEMICOLON','assignment',4,'p_assignment','compilador.py',212),
  ('if_statement -> IF LPAREN condition RPAREN THEN LBRACE statements RBRACE ELSE LBRACE statements RBRACE FI','if_statement',13,'p_if_statement','compilador.py',261),
  ('if_statement -> IF LPAREN condition RPAREN THEN LBRACE statements RBRACE FI','if_statement',9,'p_if_statement','compilador.py',262),
  ('write_statement -> WRITE expression SEMICOLON','write_statement',3,'p_write_statement','compilador.py',269),
  ('do_statement -> DO LBRACE statements RBRACE WHILE LPAREN condition RPAREN SEMICOLON','do_statement',9,'p_do_statement','compilador.py',273),
  ('while_statement -> WHILE LPAREN condition RPAREN LBRACE statements RBRACE','while_statement',7,'p_while_statement','compilador.py',279),
  ('expression -> expression PLUS term','expression',3,'p_expression','compilador.py',283),
  ('expression -> expression MINUS term','expression',3,'p_expression','compilador.py',284),
  ('expression -> term','expression',1,'p_expression','compilador.py',285),
  ('term -> term TIMES factor','term',3,'p_term','compilador.py',297),
  ('term -> term DIVIDE factor','term',3,'p_term','compilador.py',298),
  ('term -> factor','term',1,'p_term','compilador.py',299),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','compilador.py',311),
  ('factor -> NUMBER','factor',1,'p_factor','compilador.py',312),
  ('factor -> FLOAT_NUMBER','factor',1,'p_factor','compilador.py',313),
  ('factor -> IDENTIFIER','factor',1,'p_factor','compilador.py',314),
  ('condition -> expression EQUALS expression','condition',3,'p_condition','compilador.py',331),
  ('condition -> expression NOTEQUALS expression','condition',3,'p_condition','compilador.py',332),
  ('condition -> expression LESS expression','condition',3,'p_condition','compilador.py',333),
  ('condition -> expression LESSEQUAL expression','condition',3,'p_condition','compilador.py',334),
  ('condition -> expression GREATER expression','condition',3,'p_condition','compilador.py',335),
  ('condition -> expression GREATEREQUAL expression','condition',3,'p_condition','compilador.py',336),
  ('condition -> expression AND expression','condition',3,'p_condition','compilador.py',337),
  ('condition -> expression OR expression','condition',3,'p_condition','compilador.py',338),
  ('empty -> <empty>','empty',0,'p_empty','compilador.py',344),
  ('expression -> expression PLUS empty','expression',3,'p_expression_incomplete','compilador.py',358),
  ('expression -> expression MINUS empty','expression',3,'p_expression_incomplete','compilador.py',359),
]
