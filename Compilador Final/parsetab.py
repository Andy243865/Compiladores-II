...
_lr_productions = [
  ...
  ('program -> main','program',1,'p_program','sintactico.py',154),
  ('main -> MAIN LKEY declarations RKEY','main',4,'p_main','sintactico.py',158),
  ('declarations -> declarations declaration','declarations',2,'p_declarations','sintactico.py',162),
  ('declarations -> declaration','declarations',1,'p_declarations','sintactico.py',163),
  ('declaration -> declaration_variable','declaration',1,'p_declaration','sintactico.py',170),
  ('declaration -> statement','declaration',1,'p_declaration','sintactico.py',171),
  ('declaration_variable -> type variable PCOMMA','declaration_variable',3,'p_declaration_variable','sintactico.py',175),
  ('variable -> variable COMMA ID','variable',3,'p_variable','sintactico.py',207),
  ('variable -> ID','variable',1,'p_variable','sintactico.py',208),
  ('type -> INT','type',1,'p_type','sintactico.py',215),
  ('type -> DOUBLE','type',1,'p_type','sintactico.py',216),
  ('type -> STRINGKY','type',1,'p_type','sintactico.py',217),
  ('statements -> statements statement','statements',2,'p_statements','sintactico.py',221),
  ('statements -> statement','statements',1,'p_statements','sintactico.py',222),
  ('statement -> compound_statement','statement',1,'p_statement','sintactico.py',229),
  ('statement -> assign_statement','statement',1,'p_statement','sintactico.py',230),
  ('statement -> select_statement','statement',1,'p_statement','sintactico.py',231),
  ('statement -> iteration_statement','statement',1,'p_statement','sintactico.py',232),
  ('statement -> cin_statement','statement',1,'p_statement','sintactico.py',233),
  ('statement -> cout_statement','statement',1,'p_statement','sintactico.py',234),
  ('statement -> switch_statement','statement',1,'p_statement','sintactico.py',235),
  ('statement -> doublefacts','statement',1,'p_statement','sintactico.py',236),
  ('compound_statement -> LKEY statements RKEY','compound_statement',3,'p_compound_statement','sintactico.py',240),
  ('assign_statement -> ID ASSIGN expression PCOMMA','assign_statement',4,'p_assign_statement','sintactico.py',245),
  ('select_statement -> IF LPAREN expression RPAREN compound_statement','select_statement',5,'p_select_statement','sintactico.py',346),
  ('select_statement -> IF LPAREN expression RPAREN compound_statement ELSE compound_statement','select_statement',7,'p_select_statement','sintactico.py',347),
  ('iteration_statement -> WHILE LPAREN expression RPAREN compound_statement','iteration_statement',5,'p_iteration_statement','sintactico.py',354),
  ('iteration_statement -> DO compound_statement WHILE LPAREN expression RPAREN PCOMMA','iteration_statement',7,'p_iteration_statement','sintactico.py',355),
  ('switch_statement -> SWITCH LPAREN expression RPAREN LKEY case_list RKEY','switch_statement',7,'p_switch_statement','sintactico.py',362),
  ('case_list -> case_list case_statement','case_list',2,'p_case_list','sintactico.py',366),
  ('case_list -> case_statement','case_list',1,'p_case_list','sintactico.py',367),
  ('case_statement -> CASE facts PEPE statements BREAK PCOMMA','case_statement',6,'p_case_statement','sintactico.py',374),
  ('cin_statement -> CIN ID PCOMMA','cin_statement',3,'p_cin_statement','sintactico.py',378),
  ('cout_statement -> COUT expression PCOMMA','cout_statement',3,'p_cout_statement','sintactico.py',382),
  ('expression -> simple_expression relation_operator simple_expression','expression',3,'p_expression','sintactico.py',387),
  ('expression -> simple_expression','expression',1,'p_expression','sintactico.py',388),
  ('relation_operator -> EQ','relation_operator',1,'p_relation_operator','sintactico.py',428),
  ('relation_operator -> DIFF','relation_operator',1,'p_relation_operator','sintactico.py',429),
  ('relation_operator -> LESST','relation_operator',1,'p_relation_operator','sintactico.py',430),
  ('relation_operator -> LESSTEQ','relation_operator',1,'p_relation_operator','sintactico.py',431),
  ('relation_operator -> GREATT','relation_operator',1,'p_relation_operator','sintactico.py',432),
  ('relation_operator -> GREATTEQ','relation_operator',1,'p_relation_operator','sintactico.py',433),
  ('relation_operator -> AND','relation_operator',1,'p_relation_operator','sintactico.py',434),
  ('relation_operator -> OR','relation_operator',1,'p_relation_operator','sintactico.py',435),
  ('simple_expression -> simple_expression sum_operator term','simple_expression',3,'p_simple_expression','sintactico.py',456),
  ('simple_expression -> term','simple_expression',1,'p_simple_expression','sintactico.py',457),
  ('sum_operator -> PLUS','sum_operator',1,'p_sum_operator','sintactico.py',474),
  ('sum_operator -> MINUS','sum_operator',1,'p_sum_operator','sintactico.py',475),
  ('term -> term mult_operator factor','term',3,'p_term','sintactico.py',479),
  ('term -> factor','term',1,'p_term','sintactico.py',480),
  ('mult_operator -> TIMES','mult_operator',1,'p_mult_operator','sintactico.py',515),
  ('mult_operator -> DIVIDE','mult_operator',1,'p_mult_operator','sintactico.py',516),
  ('mult_operator -> MODULE','mult_operator',1,'p_mult_operator','sintactico.py',517),
  ('factor -> factor pot_operator component','factor',3,'p_factor','sintactico.py',521),
  ('factor -> component','factor',1,'p_factor','sintactico.py',522),
  ('pot_operator -> POW','pot_operator',1,'p_pot_operator','sintactico.py',534),
  ('doublefacts -> ID PLUSPLUS PCOMMA','doublefacts',3,'p_doublefacts','sintactico.py',539),
  ('doublefacts -> ID MINUSMINUS PCOMMA','doublefacts',3,'p_doublefacts','sintactico.py',540),
  ('component -> LPAREN expression RPAREN','component',3,'p_component','sintactico.py',569),
  ('component -> ID','component',1,'p_component','sintactico.py',570),
  ('component -> facts','component',1,'p_component','sintactico.py',571),
  ('component -> doublefacts','component',1,'p_component','sintactico.py',572),
  ('facts -> NUMBER','facts',1,'p_facts','sintactico.py',585),
  ('facts -> REALNUMBER','facts',1,'p_facts','sintactico.py',586),
  ('facts -> STRING','facts',1,'p_facts','sintactico.py',587),
  ('empty -> <empty>','empty',0,'p_empty','sintactico.py',592),
]
